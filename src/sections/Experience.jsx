...
const experiences = [
  ...
  },
  {
    ...
    type: 'Internship',
    points: [
      'Developed and optimized backend services using Node.js, Express.js, and MongoDB to power scalable RESTful APIs.',
      'Implemented secure server-side logic with authentication, CRUD operations, and role-based access control to strengthen application security.',
      'Collaborated closely with frontend developers to integrate 15+ APIs, enabling smooth data exchange and seamless user experiences.'
    ]
  }
];
